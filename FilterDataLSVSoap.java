 ...
 */
public class FilterDataLSVSoap {
    private final String NAMESPACE = "http://tempuri.org/";
    private final String URL = "http://10.10.10.53/teleshop/7d9f50cf-78ec-4491-b2e1-b4088cbf189b.asmx?WSDL";
    private final String SOAP_ACTION = "http://tempuri.org/FilterData_LSV_BTBCP";
    private final String METHOD_NAME = "FilterData_LSV_BTBCP";

    public FilterDataLSVSoap() {
    }
