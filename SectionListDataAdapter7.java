 ...
 */
public class SectionListDataAdapter7 extends RecyclerView.Adapter<SectionListDataAdapter7.SingleItemRowHolder> {
    ...
    public SectionListDataAdapter7(Context context, List<DataItems> itemsList) {
    ...
    public SingleItemRowHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_single_card7, null);
